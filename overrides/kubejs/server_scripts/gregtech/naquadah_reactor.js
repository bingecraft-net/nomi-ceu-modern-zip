ServerEvents.recipes(event => {
    //Reactor Crafting
    event.recipes.gtceu.assembly_line('naquadah_reactor_i')
        ...
        event.recipes.gtceu.assembly_line('naquadah_reactor_ii')
    ...
    event.recipes.gtceu.naquadah_reactor_i('process_naquadah_i')
    ...
    event.recipes.gtceu.naquadah_reactor_i('process_naquadria_i')
        .itemInputs('gtceu:naquadria_nugget') 
        .itemOutputs('gtceu:lead_nugget')
        .duration(3750)
        .EUt(-393216)

    event.recipes.gtceu.naquadah_reactor_ii('process_naquadah_ii')
        .itemInputs('gtceu:enriched_naquadah_nugget')
        .itemOutputs('gtceu:lead_nugget')
        .duration(1875)
        .EUt(-1572864)

    event.recipes.gtceu.naquadah_reactor_ii('process_naquadria_ii')
        .itemInputs('gtceu:naquadria_nugget') 
        .itemOutputs('gtceu:lead_nugget')
        .duration(7500)
        .EUt(-1572864)
